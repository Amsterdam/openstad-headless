...
service.fetchUserData = async function fetchUserData({ authConfig, userId, email, accessToken, raw = false }) {
  ...
  try {
    ...
    throw new Error('Cannot connect to auth server (1), using url: ' + url + ', getting error: ' + err);
  }
...
service.createUser = async function({ authConfig, userData = {} }) {
  ...
  try {
    ...
    throw new Error('Cannot connect to auth server (2), using url: ' + url + ', getting error: ' + err);
  }
...
service.updateUser = async function({ authConfig, userData = {} }) {
  ...
  try {
    ...
    throw new Error('Cannot connect to auth server (3), using url: ' + url + ', getting error: ' + err);
  }
...
service.deleteUser = async function({ authConfig, userData = {} }) {
  ...
  try {
    ...
    throw new Error('Cannot connect to auth server (4), using url: ' + url + ', getting error: ' + err);
  }
...
service.fetchClient = async function({ authConfig, project }) {
  ...
  try {
    ...
    throw new Error('Cannot connect to auth server (5), using url: ' + url + ', getting error: ' + err);
  }
}
...
service.createClient = async function({ authConfig, project }) {
  ...
  try {
    ...
    throw new Error('Cannot connect to auth server (6), using url: ' + url + ', getting error: ' + err);
  }
...
service.updateClient = async function({ authConfig, project }) {
  ...
  try {
    ...
    throw new Error('Cannot connect to auth server (7), using url: ' + url + ', getting error: ' + err);
  }
...
service.fetchUniqueCode = async function({ authConfig }) {
  ...
  try {
    ...
    throw new Error('Cannot connect to auth server (8), using url: ' + url + ', getting error: ' + err);
  }
}
...
service.createUniqueCode = async function({ authConfig, amount }) {
  ...
  try {
    ...
    throw new Error('Cannot connect to auth server (9), using url: ' + url + ', getting error: ' + err);
  }
}
...
service.resetUniqueCode = async function({ authConfig, uniqueCodeId }) {
  ...
  try {
    ...
    throw new Error('Cannot connect to auth server (10), using url: ' + url + ', getting error: ' + err);
  }
}
